...
//        }
     ...
     */
    @Transactional
    open suspend fun register(req: AdminRegisterRequest): AdminLoginResponse {
     ...
     */
    @Transactional
    open suspend fun logout(logType: LoginLogTypeEnum = LoginLogTypeEnum.LOGOUT_ACTIVE) {
...
//            createLoginLog(user.id, username, logTypeEnum, LoginResultEnum.BAD_CREDENTIALS);
    ...
    private suspend fun createTokenAfterLoginSuccess(user: AdminUser, logType: LoginLogTypeEnum): AdminLoginResponse {
    ...
    private suspend fun createLoginLog(
        user: LoginUser,
...
//            sessionId = sessionId,
    ...
    private suspend fun createLogoutLog(revokedSession: RevokedSessionToken, logType: LoginLogTypeEnum) {
    ...
    private suspend fun updateUserLoginIp(user: AdminUser, loginIp: InetAddress?) {
        if (loginIp == null) {
            return
        }
