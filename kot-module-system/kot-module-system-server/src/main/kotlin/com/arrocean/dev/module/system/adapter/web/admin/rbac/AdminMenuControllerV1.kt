...
open class AdminMenuControllerV1(
    ...
    open suspend fun list(): CommonResult<List<MenuResponse>> = success(
    ...
    open suspend fun create(@Body @Valid request: CreateMenuRequest): CommonResult<MenuResponse> {
    ...
    open suspend fun update(@PathVariable id: Long, @Body @Valid request: UpdateMenuRequest): CommonResult<MenuResponse> {
        val tenantId = currentLoginUserProvider.requireLoginUser().tenantId
