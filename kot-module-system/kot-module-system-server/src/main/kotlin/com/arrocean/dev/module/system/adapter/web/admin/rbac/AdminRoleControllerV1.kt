...
open class AdminRoleControllerV1(
    ...
    open suspend fun list(): CommonResult<List<RoleResponse>> = success(
    ...
    open suspend fun create(@Body @Valid request: CreateRoleRequest): CommonResult<RoleResponse> {
    ...
    open suspend fun update(@PathVariable id: Long, @Body @Valid request: UpdateRoleRequest): CommonResult<RoleResponse> {
        val tenantId = currentLoginUserProvider.requireLoginUser().tenantId
    ...
    open suspend fun assignPermissions(@PathVariable id: Long, @Body @Valid request: AssignIdsRequest): CommonResult<Unit> {
    ...
    open suspend fun delete(@PathVariable id: Long): CommonResult<Unit> {
