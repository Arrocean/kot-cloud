...
- Provide `R2DBC_URL`, `R2DBC_USER`, `R2DBC_PASSWORD`, and `REDIS_URI` through deployment secrets or environment-specific configuration.
...
- Use parameterized Micronaut Data/R2DBC access; do not construct SQL with untrusted string concatenation.
